...
const { getArticles , getArticlesById , getArticleComments , postArticleComment , patchArticleVotes, getArticlesByTopic} = require('./controllers/articles.controllers');
...
app.get('/api/:topic', getArticlesByTopic)
